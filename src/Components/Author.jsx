...
const Author = () => {
    ...
    let { github_username,name,profile_image,username } = blogDetailData.user;
	...
	<div className="space-y-4 text-center divide-y dark:divide-gray-300">
		...
		<div className="flex justify-center pt-2 space-x-4 align-center">
			<a target="blank" rel="noopener noreferrer" href={`https://github.com/${github_username}`} aria-label="Dribble"  className="p-2 rounded-md dark:text-gray-800 hover:dark:text-violet-600">
